...
X_bonafide, y_bonafide = load_and_preprocess('cqcc_training_bonafide.csv', 0)
X_spoof, y_spoof = load_and_preprocess('cqcc_training_spoof.csv', 1)
...
model = models.Sequential([
    layers.LSTM(64, return_sequences=True, input_shape=(13, 1)),
    layers.LSTM(32),
...
X_test_bonafide, y_test_bonafide = load_and_preprocess('cqcc_testing_bonafide.csv', 0)
X_test_spoof, y_test_spoof = load_and_preprocess('cqcc_testing_spoof.csv', 1)
